    ...
    <div v-if="isMultiple" class="relative" v-click-outside="closeDropdown">
      ...
      <teleport to="body">
        <div
            ...
            class="absolute z-50 bg-white border border-gray-200 ml-[-150px] md:ml-[-380px] lg:ml-73 rounded-lg shadow max-h-100 overflow-auto"
        >
...
const validate = () => {
  ...
  if (isEmpty) {
    errorMessage.value = props.errorText || "Bu maydon tanlanishi shart"
