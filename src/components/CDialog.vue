  ...
  <Teleport to="body">
    ...
    >
      <Transition name="modal" mode="out-in">
        ...
        >
          <div
              class="bg-white w-full shadow-xl relative max-h-[90vh] rounded-xl"
              :class="[
              bodyClass,
          ...
          >
            ...
            >
              <slot name="header">
                ...
                <button
                    class="w-8 h-8 !rounded-2xl border cursor-pointer border-field-stroke-secondary flex items-center justify-center absolute top-4 right-5 shrink-0 flex-center transition-300 group active:scale-95 z-40"
            ...
            <button
                ...
                class="w-8 h-8 border border-field-stroke-secondary !rounded-2xl
                 cursor-pointer flex items-center justify-center absolute top-3 right-4 shrink-0 flex-center transition-300 group active:scale-95 z-40"
                :class="closeIconClass"
                @click="$emit('close')"
            >
              <Icon
